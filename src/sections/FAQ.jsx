    ...
    >
      ...
      <div className="section-container relative z-10">
        ...
        >
          ...
          <div className="glass-card rounded-[2rem] p-4 sm:p-6 md:p-8">
          ...
          {/* Contact CTA */}
          <motion.div
            className="glass-card mt-12 rounded-[2rem] p-7 text-center md:mt-16 md:p-10"
          ...
          >
            <div className="relative z-10">
              ...
              <p className="mb-3 font-body text-sm leading-relaxed text-cream-muted md:text-base">
